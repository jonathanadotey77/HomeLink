...
class CLIPacket:
    ...
    def serialize(packet):
        return struct.pack("B512s256s", packet.packetType, packet.rsaPublicKey.encode("utf-8"), packet.data)
...
class KeyRequestPacket:
    ...
    @staticmethod
    def serialize(packet):
        return struct.pack("!BI512s", packet.packetType, packet.keysetId, packet.rsaPublicKey.encode("utf-8"))
